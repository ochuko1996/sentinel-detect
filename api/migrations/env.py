...
# side effect (see database/models/__init__.py) — required for autogenerate
# to see them.
...
# The database URL always comes from AppSettings (env vars / .env), not a
# hardcoded value in alembic.ini, so migrations run against whatever
# database the application itself is configured to use.
